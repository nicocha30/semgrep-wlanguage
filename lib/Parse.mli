...
(**
    Functions for parsing wlanguage programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a wlanguage program from a string into a typed OCaml CST.
...
(** Parse a wlanguage program from a file into a typed OCaml CST.
